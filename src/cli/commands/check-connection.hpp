#ifndef PROORIOKS_SRC_CLI_COMMANDS_CHECK_CONNECTION_HPP
#define PROORIOKS_SRC_CLI_COMMANDS_CHECK_CONNECTION_HPP
...
#endif // PROORIOKS_SRC_CLI_COMMANDS_CHECK_CONNECTION_HPP
